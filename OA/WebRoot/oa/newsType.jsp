...
<%@page import="com.a.servlet.newsListServlet"%>
<%@page import="com.a.bean.Classes"%>
...
<table  cellpadding="0" cellspacing="0" id="senfe" width="100%">
<thead>
<tr>

<td style="width: 102px; "><select name="select" dir="ltr" onchange="selected(this)">
<option>编号排序</option>
<option value="newsTypeListServlet">增序</option>
<option value="newsTypeListServletdel">降序</option>
</select></td>
<th style="width: 115px; ">分类标题</th>
<th style="width: 101px; "><a href="AddNewsType.jsp">添加新闻分类</a></th>
...
<tbody id="group_one">
<%ArrayList<Classes> clas= (ArrayList)session.getAttribute("claslist");%>
<%for(int i=0;i<clas.size();i++){%>  
<tr>
<th ><%=clas.get(i).getClassId() %> </th>
<td><%=clas.get(i).getClassName() %> </td>
<td style="width: 45px; "><a href="DelTypeServlet?Id=<%=clas.get(i).getClassId()%>">删除</a></td>
</tr>
<%}%>
</tbody >
</table>
