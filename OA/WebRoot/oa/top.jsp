...
href="http://localhost:1479/Web/sys/Top.aspx#"> <IMG 
src="Top.files/menu_seprator.gif" align=absMiddle> <A id=HyperLink2 
  href="../welcome.jsp"  target=mainFrame>返回首页</A> <IMG 
...
style="BACKGROUND-IMAGE: url(../images/bg_nav.gif); BACKGROUND-REPEAT: repeat-x; HEIGHT: 30px">
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%">
        <TBODY>
          <TR>
            <TD>
              <DIV><IMG src="Top.files/nav_pre.gif" align=absMiddle> 欢迎:<%=user.getName()%>  登录。用户角色：<%=user.getPer() %><SPAN  id=lblBra></SPAN>  <SPAN id=lblDep>&nbsp;</SPAN>   </DIV>
            </TD>
      ...
      <A 
      href="userDetail.jsp" target=mainFrame>><IMG 
      src="../images/Talk.png" align=absMiddle border=0 style="height: 19px; width: 22px">用户信息</A>
       <A href="../updatePassword.jsp" 
      target=mainFrame>
      <IMG src="Top.files/nav_resetPassword.gif" 
