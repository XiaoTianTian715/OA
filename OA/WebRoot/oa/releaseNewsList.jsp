...
<option>编号排序</option>
<option value="releaseNewsListServlet">增序</option>
<option value="releaseNewsListServletdel">降序</option>
</select></td>
<th >新闻标题</th>
<th >新闻内容</th>
<th>发布时间</th>
...
<th>审核状态</th>
	...
	<tbody id="group_one">
<%ArrayList<News> news= (ArrayList)session.getAttribute("newslistx");%>
...
<td style="width: 45px; "><a href="StudentExportController">打印</a></td>
</div>
